...
3) BinomialNode: BinomialQueue-Struct.
          ...
          Modifications:
              ...
              *For readability and ease of implementation I did not templatize this struct.
                    The linenumbersd are a list of integers; The Comparable is a String.
-------------------------------------------------------------------------
...
4) BinomialQueue: Modified BinomialQueue
          ...
          Modifications:
              ...
              Function: merge() now counts the number of comparrisons and assignments.
              Function: deleteMin now returns a list.  This was useful for outputing deletions
              Function: fastInsert(): calls private fastInsert.  Sets count to 0
              Function fast insert: Recureively looks for an index of theTrees that is NULL
